...
<body class="host_version"> 
	...
	<div class="all-title-bo" style="background-image: url(images/blog1.jpeg);">
    			...
    			<div class="col-lg-8 gallery">
      				<div class="row">
						  ...
						  <div class="gallery-grid">
						    <img src="images/AIsprint1.jpg" class="popup-img" alt="Event Photo">
						    <img src="images/AIsprint2.jpg" class="popup-img" alt="Event Photo">
						    <img src="images/AIsprint3.jpg" class="popup-img" alt="Event Photo">
						  </div>
						</div>
      				</div>
    			</div>
        ...
        <div class="container">
            <div class="section-title row text-center">
                <div class="col-md-8 offset-md-2">
                	<div class="topic">
                    <p class="lead"><h2>Kick-start your journey to becoming an industry-ready AI engineer with AI SPRINT, a hands-on In-Lab Internship Opportunity designed for II- and III-year students!</h2></p>
                    </div>
                </div>
            </div><!-- end title -->
        </div><!-- end container -->
