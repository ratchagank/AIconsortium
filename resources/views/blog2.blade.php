...
<body class="host_version"> 
	...
	<div class="all-title-bo" style="background-image: url(images/blog2.jpeg);">
		<div class="container text-center">
			<!-- <h1>Event 1<span class="m_1">Description....</span></h1> -->
		</div>
	</div>
      				...
      				<div class="row">
						<div class="gallery-container">
						  <div class="gallery-grid">
						    <img src="images/AIsprint4.jpg" class="popup-img" alt="Event Photo">
						    <img src="images/AIsprint5.jpg" class="popup-img" alt="Event Photo">
						    <img src="images/AIsprint6.jpg" class="popup-img" alt="Event Photo">
						  </div>
						</div>
      				</div>
    			</div>
        ...
        <div class="container">
            <div class="section-title row text-center">
                <div class="col-md-8 offset-md-2">
                	<div class ="topic">
                    <p class="lead"><h2>Unleash your creativity and shape the future of AI with the TCE AI Consortium Logo Design Challenge!</h2></p>
                    </div>
                </div>
            </div><!-- end title -->
